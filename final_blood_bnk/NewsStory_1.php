...
$style="NewsStory_1.css";
$script="NewsStory_1.js";
include "init.php";
?>
    ...
    <!-- start News Head -->
    <p class="spinner text-center my-4">
        <i class="fad fa-galaxy fa-spin fa-3x  text-danger"></i>
    </p>
    <section id="New" class="title py-3">
