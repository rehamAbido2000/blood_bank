...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    @$long                      = $_POST['long'];
        ...
        if(empty($formErrors)){
        insert_donate_place($name,$manager,$city_id,$start_at,$close_at,$holiday,$lat,$long);                
        }
...
async
></script> 
<input style="display: none;" type="password" disabled value="amr mohama">
<div id="layoutSidenav">     
    ...
    <div id="layoutSidenav_content">
        <div class="container-fluid ">
            ...
            <div style="margin-bottom: 80px;" class="container mainAddForm">
                ...
                <p class="secondParagraph text-center pb-5">من خلال هذه الصفحه يمكنك اضافة مكان تبرع جديد للنظام</p>
                <form method="POST" action="<?php $_SERVER['PHP_SELF'] ?>" >
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control <?php echo $name_error;?>" id="name" 
                                placeholder="ادخل اسم المكان" value="<?php if(isset($name)){ echo $name;} ?>" name="name" autocomplete="off">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="manager">اسم مدير المكان</label>
                            <input type="text" class="form-control <?php echo $manager_error;?>" id="manager" 
                                placeholder="ادخل اسم مدير المكان" value="<?php if(isset($manager)){ echo $manager;} ?>" name="manager" autocomplete="off">
                        </div>
                         <!-- gov name -->
                        ...
                        <div class="col-md-6 m-auto pb-4">
                            ...
                            <input type="time" class="form-control <?php echo $start_at_error;?>" id="start_at" 
                                  name="start_at" autocomplete="off">
                        </div>
                        <div class="col-md-6 m-auto pb-4">
                            <label for="close_at">يغلق في </label>
                            <input type="time" class="form-control <?php echo $close_at_error;?>" id="close_at" 
                    ...
                    <!--btn -> add--->
                    <button class="btn btn-primary d-block m-auto mt-5 mb-5" id="add_place">اصافة الي الاماكن</button>
                </form>
                </div>
            </div>
      </div>
