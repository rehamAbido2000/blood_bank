...
<div id="layoutSidenav">     
    <?php 
      ...
      if(in_array("vaccine_request",$roles)){
                ...
                <main>
                    ...
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">جميع طلبات اللقاحات</li>
                        </ol>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <tfoot>
                                        ...
                                        <tbody>
                                           <?php 
                                           $all_v_req = all_vaccine_request();
                                           foreach($all_v_req as $vac_requests){
                                            echo"<tr>";
                                                echo "<td>".  $vac_requests['order_id']  	."</td>";
                                                echo "<td>".  $vac_requests['vaccine_scientific_name']      	."</td>";
                                                echo "<td>".  $vac_requests['vaccine_trade_name']      	."</td>";
                                                echo "<td>".  $vac_requests['amount']      	."</td>";
                                                echo "<td>".  $vac_requests['avilable_vaccine']      	."</td>";
                                                ...
                                                echo "<td>
                                                <a href='update_admin.php?order_id=".$vac_requests['order_id']."'
                                                class='btn editbtn btn-success m-2 px-3'>قبول</a> " . "</td>";
                                                echo "<td>
                                                <a href='delete.php?from=vaccine_request&order_id=".$vac_requests['order_id']."'
